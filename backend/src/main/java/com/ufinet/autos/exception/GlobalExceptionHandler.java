...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles 404 errors when a car is not found or does not belong to the current
     * user.
     */
     ...
     * <p>
     * Example response:
     * {@code { "brand": "Brand is required", "year": "Year must be 1900 or later" }}
     */
    ...
    /**
     * Handles 400 errors for bad input detected in the service layer (e.g.,
